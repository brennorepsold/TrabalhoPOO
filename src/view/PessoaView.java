...
public class PessoaView extends JFrame {
    ...
    private PessoaController controller; // Adicionando o campo PessoaController

    public PessoaView(PessoaController controller) { // Alterando o construtor para aceitar PessoaController
        this.controller = controller; // Inicializando o controller
        initialize();
    }
        ...
        try {
            ...
            if ("Pessoa Física".equals(tipoUsuarioSelecionado)) {
                ...
                /*if (!util.Verificacoes.validarCNPJ(cnpjStr)) { 
                    util.Verificacoes.exibirPopup("Erro", "CNPJ inválido!");
                    return;
                }
                */
            ...
            util.Verificacoes.exibirPopup("Erro", "O telefone, CPF/CNPJ ou registro informado não é válido, digite somente números.");
        } catch (Exception e) {
