...
public class Processo implements Serializable {
	...
	public Processo(long numero, Cliente cliente, Pessoa parteContraria, Tribunal tribunal, Date dataAbertura)
	...
	public void addAudiencia(String recomendacao, Advogado advogado, Date data) throws AudienciaException {
		...
		audiencias.add(new Audiencia(recomendacao, advogado, data));
	}
